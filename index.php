<?php
    ...
    if(isset($_POST['email']) && $_POST['email'] != ''){
        if(filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)){
            ...
            $var1 = '<script language="javascript">alert("Gracias por suscribirte a nuestro boletín.");</script>';
            $var2 = '<script language="javascript">alert("Hubo un error al registrarte en nuestro boletín, por favor revisa tu correo.");</script>';
            $sql .=$userEmail."');";
        ...
        <div class="sb_item_c">
            <div class="sb_item">
                <div class="service-item2 d-flex flex-column justify-content-center text-center rounded">
                    ...
                    <h5 class="mb-3">Diseño Grafico</h5>
                    <p class="px-4">Producimos obra gráfica digital e impresa que generará impacto para su marca. Captamos los valores de tu empresa. </p>
        ...
        <div class="sb_item_c">
            <div class="sb_item">
                <div class="service-item2 d-flex flex-column justify-content-center text-center rounded">
                    ...
                    <p>Te ayudaremos a hallar el estilo y el tono de comunicación ideal para tu compañía para expresarte en redes sociales.</p>
        ...
        <div class="sb_item_c">
            <div class="sb_item">
                <div class="service-item2 d-flex flex-column justify-content-center text-center rounded">
                    ...
                    <p>Sea cual sea tu propósito publicitario te ayudaremos a alcanzarlo en los diversos formatos de las plataformas de difusión.</p>
        ...
        <div class="sb_item_c">
            <div class="sb_item">
                <div class="service-item2 d-flex flex-column justify-content-center text-center rounded">
                    ...
                    <p>Te ayudamos a enlazar tu firma con tus clientes a través de canales digitales plataformas sociales y demasiado mas.</p>
        ...
        <div class="sb_item_c">
            <div class="sb_item">
                <div class="service-item2 d-flex flex-column justify-content-center text-center rounded">
                    ...
                    <p>Desarrollamos tiendas virtuales amigables que te ayudarán a ofrecer tus productos de manera dinámica en internet.</p>
    ...
    <div class="container-fluid bg-white p-0">
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=51991712113&text=Hola!%20Estoy%20interesado%20en%20aumentar%20mis%20ventas%20y%20visibilidad%20de%20mi%20negocio" target="_blank" class="btn btn-light py-sm-3 px-sm-5 rounded-pill mx-2 mb-2 animated slideInLeft">Cotización Gratis</a>
            ...
            <div class="container px-lg-5">
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-4">Somos una agencia de Marketing digital especializada en estrategias digitales que llevarán tu negocio al siguiente nivel. 🚀🟠</p>
                        <div class="row g-3">
                            <div class="col-sm-6">
                        ...
                        <div class="d-flex align-items-center mt-4">
                            <a class="btn btn-primary rounded-pill px-4 me-3" href="#servicios">Leer más</a>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <h5 class="mb-3">Diseño Grafico</h5>
                            <p>Producimos obra gráfica digital e impresa que generará impacto para su marca. Captamos los valores de tu empresa. </p>
                            <a href="/diseno-grafico/" class="btn px-3 mt-auto mx-auto cursor_pointer" id="sbitopen1">Leer más</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <h5 class="mb-3">Diseño Web</h5>
                            <p>Lleve su negocio al mundo digital brindando a sus clientes un sitio web profesional, atractivo y amigable.</p>
                            <a class="btn px-3 mt-auto mx-auto cursor_pointer" id="sbitopen2">Leer más</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <h5 class="mb-3">Gestion de Redes Sociales</h5>
                            <p>Te ayudaremos a hallar el estilo y el tono de comunicación ideal para tu compañía para expresarte en redes sociales.</p>
                            <a class="btn px-3 mt-auto mx-auto cursor_pointer" id="sbitopen3">Leer más</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <h5 class="mb-3">Publicidad Digital (SEM)</h5>
                            <p>Sea cual sea tu propósito publicitario te ayudaremos a alcanzarlo en los diversos formatos de las plataformas de difusión.</p>
                            <a class="btn px-3 mt-auto mx-auto cursor_pointer" id="sbitopen4">Leer más</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <h5 class="mb-3">Marketing Digital</h5>
                            <p>Te ayudamos a enlazar tu firma con tus clientes a través de canales digitales plataformas sociales y demasiado mas.</p>
                            <a class="btn px-3 mt-auto mx-auto cursor_pointer" id="sbitopen5">Leer más</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <h5 class="mb-3">Asesoria E-commerce</h5>
                            <p>Desarrollamos tiendas virtuales amigables que te ayudarán a ofrecer tus productos de manera dinámica en internet.</p>
                            <a class="btn px-3 mt-auto mx-auto cursor_pointer" id="sbitopen6">Leer más</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid py-5" id="clientes">
            ...
            <div class="container-fluid mt-5 d-flex justify-content-center">
                <a class="btn btn-primary rounded-pill px-4 me-3" href="/clientes/">Ver más</a>
            </div>
        </div>
        <!-- Portfolio End -->
            ...
            <div class="container py-5 px-lg-5">
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item bg-transparent border rounded text-white p-4">
                        ...
                        <p>Destacamos en MARKIT la innovación, creatividad, compromiso e inmediatez para poner a nuestra disposición una gama de soluciones digitales enfocadas en resultados."</p>
                    ...
                    <div class="testimonial-item bg-transparent border rounded text-white p-4">
                        <i class="fa fa-quote-left fa-2x mb-3"></i>
                        <p>Cada día hay más competencia, pero no todos están en internet, al crear una página web con MARKIT nos mantenemos un paso adelante de tu competencia, cada día estamos más conectados a internet."</p>
                        <div class="d-flex align-items-center">
                    ...
                    <div class="testimonial-item bg-transparent border rounded text-white p-4">
                        <i class="fa fa-quote-left fa-2x mb-3"></i>
                        <p>Valoro enormemente la creatividad y la estrategia que tiene MARKIT, es un pilar importantísimo dentro de la publicidad de nuestra empresa."</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="img/testimonial-3.jpg" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h6 class="text-white mb-1">FORM Perú</h6>
                                <small>Marco Chávez</small>
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-item bg-transparent border rounded text-white p-4">
                        <i class="fa fa-quote-left fa-2x mb-3"></i>
                        <p>Fue una grata experiencia para nosotros. MARKIT comprendió todas nuestras necesidades. ¡Hicieron un gran trabajo! Sin duda alguna, lo mejor del proceso, fue la receptividad y rápida respuesta de cada uno de sus integrantes en el proyecto."</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="img/testimonial-2.jpg" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h6 class="text-white mb-1">Milky Perú</h6>
                                <small>Marlon</small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-4 mt-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="team-item">
                            ...
                            <div class="px-4 py-3">
                                <h5 class="fw-bold m-0">José Vildoso</h5>
                ...
                <div class="row g-4 mt-4">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item">
                            ...
                            <div class="px-4 py-3">
                                <h5 class="fw-bold m-0">Franco Alarcón</h5>
